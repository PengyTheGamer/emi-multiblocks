...
public class EmiModPlugin implements EmiPlugin {
    public static final EmiStack HAMMER = EmiStack.of(ContentHelper.HAMMER.get());
    public static final EmiRecipeCategory MULTIBLOCK_CATEGORY
            = new EmiRecipeCategory(ResourceLocation.fromNamespaceAndPath(JeiMultiblocks.MODID, "multiblock"), HAMMER);
